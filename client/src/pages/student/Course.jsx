...
const Course = () => {
  return (
    <Card className="bg-white transform hover:scale-105 transition-all duration-300 hover:shadow-2xl shadow-lg  rounded-lg overflow-hidden dark:bg-gray-800">
